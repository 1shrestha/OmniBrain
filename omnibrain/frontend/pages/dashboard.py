...
from components.cards import stat_card, project_card, page_hero, section_title
...
def render() -> None:
    page_hero("👋", "Welcome to OmniBrain", "Turn websites and documents into intelligent AI experiences.")

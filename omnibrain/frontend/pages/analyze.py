...
from components.cards import page_hero, section_title, stat_card, alert
...
def render() -> None:
    page_hero("🌐", "Website Analysis", "Point OmniBrain at a website and it will scrape, index, and understand it.")

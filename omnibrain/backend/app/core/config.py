...
class Settings:
    ...
    # NOTE: "gemini-2.0-flash-exp" was an experimental model ID that Google
    # has since retired -- every request against it now fails with a 404,
    # which is exactly why the chatbot was erroring out instead of
    # answering. Use a current, stable model id instead (override via env
    # var if your API key has access to a newer generation).

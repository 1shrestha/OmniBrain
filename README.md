...
| Name | Role |
|---|---|
| Shrestha Pandey | Team Lead / Developer /AI|
| Chevvakula Srikanth | Data Science |
| Vanshika Teotia | AI/ML |
| Naitik Negi | Data Science |
| Gowtham B | AI/ML |
| Sowbarnika E | AI/ML |
| Yahya Farid Khwaja | Development / AI |

## Collaboration

OmniBrain is being developed as part of an internship
and collaborative development experience with [axlero innovtions].
...
AI-powered multi-modal RAG platform for document and website
intelligence.
